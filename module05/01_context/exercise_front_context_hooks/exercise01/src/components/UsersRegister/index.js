...
function UsersRegister() {
    const { usersData, setUsersData, userInEditing, setUserInEditing } = useUser();
    ...
    return (
        <div className="left">
            ...
            <input type="number" placeholder="Age" onChange={e => setAge(e.target.valueAsNumber)} value={age} />
            <button onClick={() => (userInEditing ? handleEditUser() : handleRegisterUser())}>
